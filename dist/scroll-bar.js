...
;// CONCATENATED MODULE: ./src/resize-event.js
...
var utils_isServer = typeof window === 'undefined';
var BAR_MAP = {
  vertical: {
    offset: 'offsetHeight',
    scroll: 'scrollTop',
...
var on = function () {
  if (!utils_isServer && document.addEventListener) {
...
var off = function () {
  if (!utils_isServer && document.removeEventListener) {
    return function (element, event, handler) {
      if (element && event) {
...
/* harmony default export */ const index_0 = (main);
